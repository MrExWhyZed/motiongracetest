...
/* ─── Headline words for split-word animation ────────────────────────────── */
const headlineWords = ['Cinematic', 'CGI.'];
const headlineGoldWords = ['Infinite', 'Possibilities.'];
    ...
    <>
          ...
          <div className="preloader-content">
            ...
            <div className="preloader-text-wrap">
              <span
                ...
                style={{
                  textShadow:
                    '0 0 40px rgba(201,169,110,0.6), 0 0 80px rgba(201,169,110,0.2)',
                }}>
                {typeText}
              </span>
            ...
            <div className="preloader-line">
              <div
                ...
                style={{
                  width: preloaderPhase === 'loading' ? '100%' : '45%',
                }}
              />
            </div>
          </div>
      ...
      <section
        ...
        <div
          ...
          {/* Gold bloom top */}
          <div
            className="absolute inset-0 z-10 animate-breathe"
            style={{
              background:
                'radial-gradient(ellipse 60% 35% at 50% 0%, rgba(201,169,110,0.10) 0%, transparent 60%)',
            }}
          />
          ...
          <div
            ...
            style={{
              background:
                'radial-gradient(ellipse 25% 70% at 0% 50%, rgba(201,169,110,0.06) 0%, transparent 60%), radial-gradient(ellipse 25% 70% at 100% 50%, rgba(74,158,255,0.05) 0%, transparent 60%)',
            }}
          />
        ...
        <div
          ...
          style={{
            ...
            transition:
              'opacity 0.9s cubic-bezier(0.16,1,0.3,1) 1.2s, transform 0.9s cubic-bezier(0.16,1,0.3,1) 1.2s',
          }}>
          <div
            className="glass-dark rounded-2xl p-5 flex items-center gap-3.5"
            ...
            <div>
              <p className="text-[10px] text-muted-foreground font-medium tracking-wide mb-0.5">
                Renders Delivered
              </p>
        ...
        <div
          ...
          style={{
            ...
            transform: heroVisible
              ...
              : 'translateX(40px) translateY(-50%)',
            transition:
              'opacity 0.9s cubic-bezier(0.16,1,0.3,1) 1.4s, transform 0.9s cubic-bezier(0.16,1,0.3,1) 1.4s',
          }}>
          <div
        ...
        <div
          ...
          <div
            ...
            style={{
              ...
              transition:
                'opacity 0.8s cubic-bezier(0.16,1,0.3,1) 0.3s, transform 0.8s cubic-bezier(0.16,1,0.3,1) 0.3s, filter 0.8s cubic-bezier(0.16,1,0.3,1) 0.3s',
            }}>
          ...
          <h1 className="text-display-xl font-extrabold tracking-tighter text-foreground mb-7 max-w-4xl leading-none">
              ...
              {headlineWords.map((word, wi) => (
                <span
                  ...
                  style={{
                    ...
                    transition: `opacity 0.75s cubic-bezier(0.16,1,0.3,1) ${0.45 + wi * 0.13}s, transform 0.75s cubic-bezier(0.16,1,0.3,1) ${0.45 + wi * 0.13}s`,
                  }}>
                  {word}
                </span>
              ))}
              ...
              {headlineGoldWords.map((word, wi) => (
                <span
                  ...
                  style={{
                    ...
                    opacity: heroVisible ? 1 : 0,
                    transform: heroVisible ? 'translateY(0)' : 'translateY(32px)',
                    transition: `opacity 0.75s cubic-bezier(0.16,1,0.3,1) ${0.72 + wi * 0.13}s, transform 0.75s cubic-bezier(0.16,1,0.3,1) ${0.72 + wi * 0.13}s`,
                  }}>
                  {word}
                </span>
              ))}
          ...
          <p
            ...
            style={{
              ...
              transform: heroVisible ? 'translateY(0)' : 'translateY(20px)',
              transition:
                'opacity 0.9s cubic-bezier(0.16,1,0.3,1) 1.0s, transform 0.9s cubic-bezier(0.16,1,0.3,1) 1.0s',
            }}>
          ...
          <div
            ...
            <button
              ...
              className="hero-btn-outline group relative px-9 py-4 rounded-full text-xs font-semibold uppercase tracking-[0.18em] text-foreground/80 border border-foreground/15 hover:border-primary/50 hover:text-foreground overflow-hidden">
              ...
              <div className="absolute inset-0 overflow-hidden opacity-0 group-hover:opacity-100">
                <div className="absolute top-0 left-0 w-1/3 h-full bg-gold-shimmer animate-light-sweep" />
              </div>
            </button>
            ...
            <button
              ...
              className="hero-btn-primary relative px-9 py-4 rounded-full text-xs font-semibold uppercase tracking-[0.18em] text-primary-foreground bg-primary overflow-hidden group animate-pulse-gold">
      ...
      <style>{`
        ...
        .hero-section {
          ...
          overflow: hidden;
          transition:
            opacity 1.0s cubic-bezier(0.16,1,0.3,1) 0.1s,
        ...
        @media (min-width: 1280px) {
          .hero-widget-right { right: 3rem; }
        }
        @media (max-width: 1023px) {
          .hero-widget-left,
          .hero-widget-right { display: none !important; }
        }
        ...
        .hero-btn-outline:hover {
          box-shadow: 0 0 24px rgba(201,169,110,0.14);
